...
namespace Molsketch {
  ...
  void RadicalElectron::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget) {
    ...
    painter->save(); // TODO write test for this: general assertion that painter state is unaltered before & after: mock painter and check that save & restore are called appropriately
